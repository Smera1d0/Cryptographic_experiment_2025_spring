...
def genModel():
    ...
    # declare variables
    X =  [ [ m.addVar( vtype = GRB.BINARY ) for i in range(64) ] for j in range(3) ]
    P0 = [ [ m.addVar( vtype = GRB.BINARY ) for i in range(16) ] for j in range(2) ]
    P1 = [ [ m.addVar( vtype = GRB.BINARY ) for i in range(16) ] for j in range(2) ]
